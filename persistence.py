...
from time_utils import get_yesterday, get_lastweek, get_prevweek
...
class DBUser:
    ...
    def remove_tacos(self, amount):
        users_db.update(subtract('daily_tacos', abs(amount)), Query()['user_id'] == self.user_id)
        self.update()
